    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ paddingTop: '10%' }}>
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          <Text style={{ color: '#994E09', fontSize: 55 }}>Refrescos</Text>
        </View>
        <View style={{ flexDirection: 'row', top: 10, height: 165 }}>
          ...
          <View style={{ justifyContent: 'center', paddingLeft: 8 }}>
            <Text style={{ fontSize: 35, color: '#994E09', width: '120%' }}>Coca-Cola</Text>
            <Text style={{ paddingTop: '9%', fontSize: 25, color: '#994E09', width: '120%' }}>Cantidad: 600 ml</Text>
          </View>
        </View>
